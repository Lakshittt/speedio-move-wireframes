...
export { KYCWireframe } from "./screens/KYCWireframe";
export { TrackingWireframe } from "./screens/TrackingWireframe";
export { TrainingWireframe } from "./screens/TrainingWireframe";
export { SettingsWireframe } from "./screens/SettingsWireframe";
